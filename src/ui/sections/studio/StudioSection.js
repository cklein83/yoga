...
export default function StudioSection() {
  return (
    <section id="studio" className="p-10 lg:p-20 scroll-mt-20">

      <div className="flex flex-col lg:flex-row justify-center mb-10 lg:mb-20">

        <div className="lg:w-1/3 lg:px-4 px-2 self-center">
        ...
        <div className="w-full lg:w-1/3 px-2 lg:px-4 items-center">
          <Image
      ...
      <div className="flex flex-col lg:flex-row justify-center mb-5 lg:mb-10">
        <div className="w-full lg:w-1/3 px-2 lg:px-4">
          <Image
            className="rounded-lg text-center mb-3"
            src="/yoga2b.webp"
            alt="Seerose"
        ...
        <div className="w-full lg:w-1/3 px-2 lg:px-4 self-center">
          <p className="max-w-2xl mb-6 font-light text-gray-500 lg:mb-8 md:text-lg lg:text-xl dark:text-gray-400 mb-10">
      ...
      <div className="flex flex-col items-center p-5 lg:p-10">
        ...
        <div className="text-center">
          <p className="max-w-2xl font-light text-gray-500 md:text-lg lg:text-xl mb-2">
            In Zusammenarbeit mit <span className="font-bold">Auszeit Alexandra Germer</span>.
          </p>
          <p className="font-medium text-blue-600 hover:underline md:text-lg lg:text-xl ">
