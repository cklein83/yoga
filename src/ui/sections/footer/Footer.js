    ...
    <footer class="mt-10 bg-white">
      <div class="max-w-screen-xl p-4 py-6 mx-auto lg:py-16 md:p-8 lg:p-10">
        ...
        <div class="grid grid-cols-2 gap-8 md:grid-cols-3 lg:grid-cols-5">
          ...
          <div>
            <h3 class="mb-6 text-sm font-semibold text-gray-900 uppercase dark:text-white">Seiten</h3>
          ...
          <div>
            ...
            <ul class="text-gray-500 dark:text-gray-400">
              <li class="mb-4">
                <Link href="/impressum" class="hover:underline">Impressum</Link>
              </li>              
              <li class="mb-4">
          ...
          <div>
            <h3 class="mb-6 text-sm font-semibold text-gray-900 uppercase dark:text-white">Kontakt</h3>
            <ul class="text-gray-500 dark:text-gray-400">
              <li class="mb-4">
                Michael Frisch
              </li>
          ...
          <div>
            <h3 class="mb-6 text-sm font-semibold text-gray-900 uppercase dark:text-white">Adresse</h3>
            <ul class="text-gray-500 dark:text-gray-400">
              <li class="mb-4">
                <a href="https://goo.gl/maps/RUFDNWTiJwuEnRnF8" class=" hover:underline" target="_blank">Yogacenter Obersulm</a>
              </li>
              <li class="mb-4">
                <a href="https://goo.gl/maps/RUFDNWTiJwuEnRnF8" class="hover:underline" target="_blank">Edith-Stein-Straße 2</a>
              </li>
              <li class="mb-4">
          ...
          <div>
            <h3 class="mb-6 text-sm font-semibold text-gray-900 uppercase dark:text-white">Outdoor</h3>
            <ul class="text-gray-500 dark:text-gray-400">
              <li class="mb-4">
                <a href="https://maps.app.goo.gl/23wc7J4r5z8b6WWt6" class=" hover:underline" target="_blank">Yoga Obersulm</a>
              </li>
              <li class="mb-4">
                <a href="tel:+4915208807315" class="hover:underline" target="_blank">Tel.: +49 (0)1520 8807315</a>
              </li>
              <li class="mb-4">
        ...
        <div class="text-center">
          ...
          <span class="block text-sm text-center text-gray-500">
            Developed by <a href="https://www.modulseiten.com" class="underline" target="_blank">Modulseiten KLEIN</a>
          </span>
